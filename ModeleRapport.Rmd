...
$$
X=\left(X_{ij}\right)_{i\in\{1,\ldots,150\},\ j\in\{1,\ldots,4\}}.
$$
...
Nous nous intéressons maintenant aux 4 variables quantitatives (matrice $X$). La Figure \ref{fig:corrplot}  montre les corrélations entre les 4 variables. On peut remarquer que la largeur et la longuer des pétales sont fortement corrélées positivement, ce n'est pas le cas pour les sépales. 
