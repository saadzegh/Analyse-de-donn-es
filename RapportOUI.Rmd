...
```
Decrivez l’ensemble du jeu de donn´ees en pr´ecisant la nature des variables.
Utiliser des commandes (comme dans le cours) pour montrer ou on a obtenu les infos
...
```
LOOOOOOL C'EST MAGNIFIQUE (NON A L'AIDE Y'A TROP DE VARIABLES) LOLILOOOOL
Garder le grand pour interpréter que T1 du replicat 1 est pas super corrélé au T1 du réplicat 2
